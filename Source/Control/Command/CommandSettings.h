...
namespace Konclude {
	...
	namespace Control {
		...
		namespace Command {
			...
			const qint64 FORCEROLEREALIZATIONQUERYCOMMAND										= 2104;
			const qint64 CCONSTRUCTFORCEROLEREALIZATIONQUERYCOMMAND								= 2105;
			const qint64 FORCESAMEINDIVIDUALSREALIZATIONQUERYCOMMAND							= 2106;
			const qint64 CCONSTRUCTFORCESAMEINDIVIDUALSREALIZATIONQUERYCOMMAND					= 2107;
